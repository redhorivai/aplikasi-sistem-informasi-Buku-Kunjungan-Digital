				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="kode_unit" name="kode_unit" placeholder="masukan kode unit kerja" onchange="remove(id)">
						</div>
						<div class="form-group">
							<label>Nama Unit: <span class='text-danger'>*</span></label>
							<input type="email" class="form-control" id="nama_unit" name="nama_unit" placeholder="masukan nama unit kerja" onchange="remove(id)">
						</div>
						<div class="form-group">
